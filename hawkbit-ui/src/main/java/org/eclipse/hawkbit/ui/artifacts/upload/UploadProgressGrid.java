...
public class UploadProgressGrid extends Grid<ProxyUploadProgress> {
    ...
    private final Map<ProgressSatus, FontIcon> progressStatusIconMap = new EnumMap<>(ProgressSatus.class);
    ...
    private Label buildProgressStatusIcon(final ProxyUploadProgress uploadProgress) {
        final FontIcon progressStatusFontIcon = Optional
    ...
    private Label buildLabelIcon(final FontIcon fontIcon, final String id) {
