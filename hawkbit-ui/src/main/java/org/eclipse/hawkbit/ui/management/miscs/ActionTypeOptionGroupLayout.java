...
public class ActionTypeOptionGroupLayout extends HorizontalLayout {
    ...
    private void addValueChangeListener() {
        actionTypeOptionGroup.addValueChangeListener(e -> {
            if (e.getSource().equals(ActionTypeOption.AUTO_FORCED)) {
    ...
    private void createOptionGroup() {
        ...
        // final Label forceItem =
        // actionTypeOptionGroup.getItemComponent(ActionTypeOption.FORCED);
        ...
        autoForceLabel.setIcon(VaadinIcons.ADOBE_FLASH);
