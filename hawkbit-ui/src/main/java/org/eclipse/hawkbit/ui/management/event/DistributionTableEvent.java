 ...
 * distributions table
 */
public class DistributionTableEvent extends BaseUIEntityEvent<ProxyDistributionSet> {
     ...
     */
    public DistributionTableEvent(final BaseEntityEventType eventType, final ProxyDistributionSet entity) {
    ...
    public DistributionTableEvent(final BaseEntityEventType eventType, final Collection<Long> entityIds) {
        super(eventType, entityIds, ProxyDistributionSet.class);
    }
