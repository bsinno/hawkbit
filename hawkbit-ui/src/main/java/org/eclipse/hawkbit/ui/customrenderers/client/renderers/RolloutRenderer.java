...
public class RolloutRenderer extends ClickableRenderer<RolloutRendererData, VButton> {
    ...
    public VButton createWidget() {
        final VButton b = GWT.create(VButton.class);
    ...
    @Override
    public void render(final RendererCellReference cell, final RolloutRendererData text, final VButton button) {
    ...
    private void applystyle(final VButton button) {
