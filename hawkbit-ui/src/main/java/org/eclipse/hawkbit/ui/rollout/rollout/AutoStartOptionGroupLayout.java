...
public class AutoStartOptionGroupLayout extends HorizontalLayout {
    ...
    private void createOptionGroup() {
        ...
        autoStartOptionGroup.setItems(AutoStartOption.MANUAL, AutoStartOption.AUTO_START, AutoStartOption.SCHEDULED);
        selectDefaultOption();

        // final FlexibleOptionGroupItemComponent manualItem =
        // autoStartOptionGroup
        ...
        //
        // final FlexibleOptionGroupItemComponent autoStartItem =
        // autoStartOptionGroup
        ...
        //
        // final FlexibleOptionGroupItemComponent scheduledItem =
        // autoStartOptionGroup
    ...
    void selectDefaultOption() {
        autoStartOptionGroup.setSelectedItem(AutoStartOption.MANUAL);
    }
