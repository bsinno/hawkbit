 ...
 *
 */
public final class SpColorPickerPreview extends ColorPickerPreview {
    ...
    public SpColorPickerPreview(final Color color) {
        ...
        try {
            ...
            // ((TextField) textField.get(this)).addListener(this);
    ...
    // @Override
    // public void textChange(final
    // com.vaadin.v7.event.FieldEvents.TextChangeEvent event) {
