...
public class AddTargetTagWindowLayout extends AbstractTagWindowLayout {
    private static final long serialVersionUID = 1L;

    protected final TextField tagName;

    public AddTargetTagWindowLayout(final VaadinMessageSource i18n) {
        super(i18n);

        this.tagName = componentBuilder.createNameField(UIComponentIdProvider.NEW_TARGET_TAG_NAME, proxyTagBinder);
