...
@ActiveProfiles({ "test" })
@WithUser(principal = "bumlux", allSpPermissions = true, additionalAuthorities = { CONTROLLER_ROLE, SYSTEM_ROLE })
@SpringBootTest
...
public abstract class AbstractIntegrationTest {
     ...
     * generated by using {@link TestdataFactory#findOrCreateDefaultTestDsType()}
     * and three {@link SystemManagement#getTenantMetadata()};
     */
    ...
    /**
     * Test helper method to assign distribution set to a target with a maintenance
     * schedule.
     *
     * @param dsID
     ...
     *            is the cron expression to be used for scheduling the maintenance
     *            window. Expression has 6 mandatory fields and 1 last optional
     ...
     *
     * @return result of the assignment as { @link DistributionSetAssignmentResult}.
     */
    ...
    private static final String artifactDirectory = Files.createTempDir().getAbsolutePath() + "/"
    ...
    /**
     * Gets a valid cron expression describing a schedule with a single maintenance
     * window, starting specified number of minutes after current time.
     *
     * @param minutesToAdd
